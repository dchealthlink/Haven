...
if ($formsubmit) {
	...
	if ($_POST['actionType']) {
		...
		break;
		case 'link':	
			$sql = "INSERT INTO user_story_action (userstoryid, action_type, action_inc, action_value, owner, status_timestamp, comments) values ('".$usId."','".$_POST['actionType']."','".$nextval."','".$_POST['linkvalue']."','".$_SESSION['userid']."', now(), '".$_POST['comments']."' ) ";
		break;
		case 'xref':	
			$sql = "INSERT INTO user_story_action (userstoryid, action_type, action_inc, action_value, owner, status_timestamp, comments) values ('".$usId."','".$_POST['actionType']."','".$nextval."','".$_POST['usecaseId']."','".$_SESSION['userid']."', now(), '".$_POST['comments']."' ) ";
		break;
		default:	
