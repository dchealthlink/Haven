...
$sql="SELECT notification_id, notice_cd, post_timestamp, pickup_timestamp, notice_template, notice_subject FROM notification WHERE notice_level < 9 "; 
...
if ($i == 0) {
	echo "<td><b><a href='notice_data_report.php?notification_id=".$test."'>$test</a></b></td>";
