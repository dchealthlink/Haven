...
//				$datastring.=' ( ';
		...
		//			echo "prop2 = ".$prop2."  and value2 = ".$value2."<br>";
		...
		switch ($prop) {
			...
			default:
				...
				$datastring.=' "totalbenchmarkamount" : "'.$total_BenchmarkAmount.'," ';
				$datastring.=' "householdIncome" : "'.$householdIncome.'" ';
$datastring = substr($datastring,0,-1).', '.substr($appldatastring,0,-1).' } ';
