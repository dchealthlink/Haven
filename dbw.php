...
//$params = array('CountryName' => $_GET['co'], 'CityName' => $_GET['ci']); $response = $client->GetWeather(array('CityName' => 'Lagos', 'CountryName' => 'Nigeria'));

// $response = $soapclient->getWeather($params);

$obj = $soapclient->GetWeather($params);

$outfile = fopen("/tmp/dummy_obj.xml","w") ;
$putline = $obj->GetWeatherResult;
