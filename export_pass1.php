...
$outfile = fopen("/tmp/export_pass1.csv","w") ;

$sql = "SELECT policyno, fullname, birthday, appreference, typecode, gender, zip, planname, carrier, premium, totalcost, aptc, startdate, enddate, motivation, metal, programcode, status, age, agegroup, pdc FROM enrollappdata ORDER BY lastname, firstname LIMIT 500";
